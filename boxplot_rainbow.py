...
def getplot1(data,N,c,traces0,mylayout,namelist):
...
def getplot2(data,N,c,traces0,mylayout,namelist):
...
def getplot3(data,N,c,traces0,mylayout,namelist):
    
    # Each box is represented by a dict that contains the data, the type, and the colour. 
    # Use list comprehension to describe N boxes, each with a different colour and with different randomly generated data:

    for i in range(int(N)):
        valence=data[data['Yr_group']==i]
     #valence=gross.drop_duplicates(subset='valence',keep='last')
        traces0.append(go.Box(
...
def main():
    ...
    mylayout={'xaxis': {'showgrid':False,'zeroline':False, 'tickangle':60,'showticklabels':False},
          'yaxis': {'zeroline':False,'gridcolor':'white'},
          'paper_bgcolor': 'rgb(233,233,233)',
          'plot_bgcolor': 'rgb(233,233,233)',
          }
    getplot1(data,N,c,traces0,mylayout,namelist)
    getplot2(data,N,c,traces0,mylayout,namelist)
    getplot3(data,N,c,traces0,mylayout,namelist)
