...
# Check to see whether there are relationships between two columns
...
def main():
    ...
    # Second, check the outliers by DBSCAN
    ...
    # First,use 'instrumentalness','tempo','loudness'
    # to detect outliers
    odcolumns=['tempo','loudness','instrumentalness']
